# HR PRO — ระบบบริหารทรัพยากรบุคคลสำหรับองค์กร
...
### 🆕 โมดูล Phase 2 (ส่งมอบแล้ว ✅)

| โมดูล | รายละเอียด |
|---|---|
| **Payroll / เงินเดือน** | คำนวณเงินเดือนรายเดือน (หักลาไม่รับค่าจ้างอัตโนมัติ), สลิปเงินเดือน, ยืนยันสลิป |
| **Recruitment / สรรหา** | ประกาศรับสมัครงาน + ติดตามผู้สมัครตามขั้น (สมัคร → คัดกรอง → สัมภาษณ์ → รับเข้า) |
| **Performance Review** | บันทึก/ดูผลการประเมิน (คะแนน 1–5, จุดแข็ง, สิ่งที่ต้องพัฒนา) |
| **Training** | หลักสูตรฝึกอบรม + การลงทะเบียน + ทำเครื่องหมายจบหลักสูตร |
| **Document Management** | คลังเอกสารองค์กร — อัปโหลด/ดาวน์โหลด/ลบ แยกหมวดหมู่ |
| **Org Chart** | ผังองค์กรเชิงกราฟิกจากข้อมูลแผนก/หัวหน้า (รองรับแผนกย่อยแบบ recursive) |
| **Export Excel/PDF** | ส่งออก CSV (ทะเบียนพนักงาน/เงินเดือน, รองรับภาษาไทยใน Excel) + พิมพ์สลิปเป็น PDF ผ่านเบราว์เซอร์ |
| **Email / LINE Notifications** | ส่งการแจ้งเตือนออกทางอีเมล และ LINE (เมื่อกำหนด token) เพิ่มเติมจากในระบบ |
| **Multi-language** | สลับภาษา ไทย / English (session + middleware) |
| **Self-service Onboarding** | เช็กลิสต์เริ่มงานสำหรับพนักงานใหม่ พร้อมแถบความคืบหน้า |

> 📐 ดูสถาปัตยกรรม, ERD, RBAC, business flows และ Design System แบบละเอียด (พร้อมไดอะแกรม Mermaid) ใน **[DESIGN.md](DESIGN.md)** · การจัดสเตจดูได้ในส่วน *Feature Map* ด้านล่าง
